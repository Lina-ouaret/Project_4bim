...
### Tutoriel 
***
You can find in the "Tutorial" folder notebooks : 
- Tutoral_Ag explaining how to create functions for the algorithm genetic 
- Tutoral_NN explaining how to create functions for the Neural Network 
